...
function App() {
  ...
  const incorrectLetters = guessedLetters.filter((key)=>!wordToGuess.includes(key))
  ...
  return (
    ...
    <div className="flex flex-col col-span-12 md:col-span-7">
      <HangmanWord isLoser={isLoser} wordToGuess={wordToGuess} guessedLetters={guessedLetters}/>
