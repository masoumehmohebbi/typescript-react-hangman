  ...
  const BODY = (
    <div className="absolute bg-yellow-500 w-2 h-20 top-20 left-[calc(100%_-_1rem)] md:left-[calc(100%_+_3rem)]"></div>
  )
  const RIGHT_HAND = (
    <div className=" absolute bg-yellow-500 w-2 rotate-[60deg] origin-bottom-left h-16 top-16 left-[calc(100%_-_1rem)] md:left-[calc(100%_+_3rem)]"></div>
  )
  const LEFT_HAND = (
...
export default function HangmanDrawing({numOFIncorrectLetters}:HangmanDrawingProps) {
    ...
    return <section className="mt-4">
      <div className="relative w-[280px] min-[400px]:mx-auto h-60 md:h-96 flex justify-center items-center">
        ...
        <div className="w-2/3 md:w-full h-2 bg-yellow-900 absolute bottom-0"></div>
      </div>
    </section>
  }